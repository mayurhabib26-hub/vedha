...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 500" width="100%" height="100%">
  <defs>
    ...
    <linearGradient id="vedhaMasterGold" x1="0%" y1="0%" x2="100%" y2="85%">
      ...
      <stop offset="15%" stop-color="#FCE182" />
      <stop offset="35%" stop-color="#DEB03C" />
      <stop offset="58%" stop-color="#F7DA76" />
      <stop offset="80%" stop-color="#B8851E" />
      <stop offset="100%" stop-color="#7B520A" />
    </linearGradient>

    <!-- Horizontal Linear Gradient for Top Crossbar -->
    <linearGradient id="vedhaMasterBar" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="#A57314" />
      <stop offset="12%" stop-color="#F7D875" />
      <stop offset="30%" stop-color="#FFF9DE" />
      <stop offset="50%" stop-color="#ECC558" />
      <stop offset="75%" stop-color="#FCE389" />
      <stop offset="90%" stop-color="#D9A833" />
    ...
    <filter id="vedhaDepth" x="-10%" y="-10%" width="125%" height="125%">
      ...
      <feDropShadow dx="0" dy="0" stdDeviation="1.5" flood-color="#FFF8D6" flood-opacity="0.35" />
    </filter>
  </defs>
  ...
  <g filter="url(#vedhaDepth)">
    ...
    <!-- Note: Symmetrically flaring outward relative to 'd's descender! -->
    <path
      d="M 564 320
...
fs.writeFileSync('./public/vedha-logo.svg', svg);
fs.writeFileSync('./public/vedha-logo-transparent.svg', svg);
console.log('Successfully generated authentic master vector logo!');
